...
router.post('/token/verificar', (req, res)=>{
...
function sendmail(mail) {
    ...
    var link = 'https://www.miau.com'
        transporter.sendMail({
        from: '<juanlandia3000@gmail.com>', // sender address
...
router.get('/intentar', (req, res)=>{
    console.log("miau")
    sendmail('vasco.giraldo.juan.esteban@gmail.com')
    res.json({status: "miau"})
});
