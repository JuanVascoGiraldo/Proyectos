...
public class RegistrarDieta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(request.getParameter("nombre") != null && request.getParameter("descripcion") != null 
                    && request.getParameter("clasificacion") != null && sesion.getAttribute("id") != null){
                    ...
                    if(r == true && r2 == true && r4 == true && ((Integer)sesion.getAttribute("permiso")) == 1){
                        ...
                        int estatus = AccionesDieta.Agregardieta(d);
                        if(estatus >0){
