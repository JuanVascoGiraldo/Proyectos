...
public class EliminarDietadeUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(sesion.getAttribute("id") != null && request.getParameter("id_die") != null){
                ...
                if(r == true && ((Integer)sesion.getAttribute("permiso")) == 0){
                    ...
                    int estatus = AccionesDieta.EliminarDietadeUsuario(id_usu, id_die);
                    if(estatus > 0){
