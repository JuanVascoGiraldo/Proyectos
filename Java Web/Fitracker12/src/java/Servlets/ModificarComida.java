...
public class ModificarComida extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int id;
            if(request.getParameter("nombre") != null && request.getParameter("descripcion") !=null && request.getParameter("ID") !=null
                ...
                if(r == true && r2 == true && r3 == true && ((Integer)sesion.getAttribute("permiso")) == 1){
                    ...
                    c.setId(id);
                    int estatus = AccionesComida.modificarcomida(c);
                    if(estatus > 0){
