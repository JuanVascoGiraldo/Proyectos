...
public class AgregarAnime extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(sesion.getAttribute("id") != null && sesion.getAttribute("nombre") != null){
                ...
                anime.setCapitulos(cap);
                anime.setId_gen(genero);
                anime.setId_lista(idusu);
                anime.setDes_anime(nombre);
                if(ConexionAPI.agregaranime(anime)){
